 ...
 *
 *   - `packages/build/tests/parity-divergences.test.ts` — end-to-end
 *     `generateSchemas` cross-consumer comparison.
 *   - `packages/build/tests/alias-chain-propagation.test.ts` —
...
import type { FormSpecAnalysisDiagnostic } from "../src/protocol.js";
...
const FIXTURES: readonly ParityFixture[] = [
  ...
  //   - packages/build/tests/parity-divergences.test.ts:178-232
  //     (builds the real build path and snapshot consumer over the same
  //     source, asserts matching TYPE_MISMATCH)
  //   - packages/analysis/tests/constraint-applicability.test.ts
