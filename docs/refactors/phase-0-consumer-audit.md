...
**Status**: **EXPORTED** via `packages/analysis/src/index.ts:155` and `packages/analysis/src/internal.ts` (re-export). Called internally by batch infrastructure and tested extensively.
...
**Status**: **EXPORTED** via `packages/analysis/src/index.ts:156`. Core public API used by tsdoc-parser.
...
**Status**: **EXPORTED** via `packages/analysis/src/index.ts:157`. Core public API used by file-snapshots batch builder.
...
**Status**: **EXPORTED** via `packages/analysis/src/index.ts:159`. Used internally by batch infrastructure and directly by file-snapshots to pre-validate lowering.
...
**Status**: **EXPORTED** via `packages/analysis/src/index.ts` (types only). No call sites found in active code; appears to be public API reserved for potential tooling use.
...
**Status**: **EXPORTED** (types only via `packages/analysis/src/index.ts:143-145`). No production call sites found; narrow mode is test-only/tooling-reserved. Never called from build-analyzer or file-snapshots.
...
|--------|------------|-----------------|-------------------|
| `buildSyntheticHelperPrelude` | `compiler-signatures.ts:545` | `index.ts:155` | ✓ `@formspec/analysis` default export |
| `checkSyntheticTagApplication` | `compiler-signatures.ts:1181` | `index.ts:156` | ✓ `@formspec/analysis` default export |
| `checkSyntheticTagApplications` | `compiler-signatures.ts:1113` | `index.ts:157` | ✓ `@formspec/analysis` default export |
| `lowerTagApplicationToSyntheticCall` | `compiler-signatures.ts:580` | `index.ts:159` | ✓ `@formspec/analysis` default export |
| `getMatchingTagSignatures` | `compiler-signatures.ts:387` | `internal.ts` (no line) | ✓ `@formspec/analysis/internal` export |
| (types) `CheckNarrowSyntheticTagApplicabilityOptions` | `compiler-signatures.ts` | `index.ts:144` | ✓ `@formspec/analysis` type export |
| (types) `CheckNarrowSyntheticTagApplicabilitiesOptions` | `compiler-signatures.ts` | `index.ts:143` | ✓ `@formspec/analysis` type export |
